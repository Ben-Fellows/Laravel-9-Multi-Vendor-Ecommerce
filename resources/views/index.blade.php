                                      ...
                                      @if (session('status'))
                                        ...
                                        <div class="row">                                          
                                            <div class="form-group col-md-12">
                                                ...
                                                <input class="form-control @error('old_password') is-invalid @enderror" name="old_password" type="password" id="current_password" placeholder="Enter Your Current Password" />
                                                @error('old_password')
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <input class="form-control @error('new_password') is-invalid @enderror" name="new_password" type="password" id="new_password" placeholder="Enter Your New Password" />
                                                @error('new_password')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="form-group col-md-12">
                                                ...
                                                <input class="form-control" name="new_password_confirmation" type="password" id="new_password_confirmation" placeholder="Confirm Your New Password" />
